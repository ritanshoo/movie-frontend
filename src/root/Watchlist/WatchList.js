...
let WatchList = () =>{
    ...
    let removeFromWatchList = (id) => {
        dispatch(movieAction.removeMovieFromWatchList(id))
    }

    return(
        <React.Fragment>
                    <div>
                        <h3 className="ml-2 text-capitalize h2">   Watch List</h3>
                    </div>
            <div className='row'>
                        ...
                        return(
                            <div className="col">
                                ...
                                <div className="card-body bg-light font-weight-bold">
                                    ...
                                    <div>
                                        <Link className="btn btn-warning btn-large" onClick={removeFromWatchList.bind(this,each_movie._id)}> Remove From Watch List</Link>
                                    </div>
                                </div>
                        </div>
                        )
